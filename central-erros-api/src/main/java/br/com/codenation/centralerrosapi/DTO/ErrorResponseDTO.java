...
public class ErrorResponseDTO {
    ...
    public ErrorResponseDTO(UUID id, @NotNull(message = "Environment required.") @Size(max = 50) String environment, @Size(max = 50) @NotNull(message = "Description required.") String description, @NotNull(message = "Level required") char level, @Size(max = 50) @NotNull(message = "Origin required.") String origin, @NotNull(message = "Frequency required.") int frequency, @NotNull(message = "Event Date required.") LocalDate eventDate) {
        this.id = id;
